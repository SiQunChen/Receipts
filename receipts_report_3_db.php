...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $spreadsheet->getProperties()
        ...
        ->setTitle("Receipts Report3")
        ->setSubject("Receipts Report3")
        ->setDescription("Receipts Report3")
        ->setKeywords("Receipts Report3")
        ->setCategory("Receipts Report3 file");
    ...
    $sheet->getStyle("A1:K2")->applyFromArray($titleFontStyle);
    $sheet->getStyle('E2')->getFont()->setName('Calibri');
    $sheet->getStyle('F2')->getFont()->setName('Calibri');
    $sheet->getStyle('G2')->getFont()->setName('Calibri');
    $sheet->getStyle('J1')->getFont()->setName('Calibri');
    $sheet->getStyle('J2')->getFont()->setName('Calibri');
    ...
    $len = count($title);
    $end = 'K' . $excelRow;
    $sheet->getStyle("A1:$end")->applyFromArray($styleArray);

    // 設定檔案名
    $filename = 'receipts_report3_' . date('Ymd') . '.xlsx';
